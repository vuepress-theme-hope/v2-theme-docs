...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>必填: 否</p></li></ul><p>Markdown 增强插件的国际化配置。</p>`,10);function Z(N,K){const c=t("ProjectLink"),i=t("ExternalLinkIcon");return l(),o("div",null,[m,n("div",v,[k,b,n("p",null,[s("有关更多详细信息，请参见 "),e(c,{name:"md-enhance",path:"/zh/config.html"},{default:p(()=>[s("md-enhance 文档")]),_:1}),s("。")])]),h,g,Q,f,n("div",T,[y,n("p",null,[s("有关完整的 GFM 语法，请参阅 "),n("a",x,[s("GFM"),e(i)]),s("。")]),w,_]),q,n("p",null,[s("是否通过 KaTeX 启用 "),n("mjx-container",H,[(l(),o("svg",L,j)),P]),s(" 语法支持。你可以传入一个对象作为 KaTeX 的配置选项。")]),O,n("p",null,[s("可用的选项，详见 "),n("a",C,[s("Katex 文档"),e(i)]),s("。")]),S,R,n("p",null,[s("是否通过 Math Jax 启用 "),n("mjx-container",z,[(l(),o("svg",D,E)),J]),s(" 语法支持。你可以传递一个对象来配置 Math Jax。")]),n("p",null,[s("可用的选项，详见 "),n("a",I,[s("源代码"),e(i)]),s("。")]),G,n("p",null,[s("是否启用 "),n("a",F,[s("Mermaid"),e(i)]),s(" 支持。")]),B,r(' - `"anything"`\n- `"audio"`\n- `"chalkboard"` '),X])}const A=d(u,[["render",Z],["__file","md-enhance.html.vue"]]);export{A as default};
