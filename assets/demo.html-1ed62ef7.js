...
`),n("span",{class:"token code-block language-json"},`// 配置 (可选)
{
  "jsLib": [
    ...
  ],
...
`),n("span",{class:"token code-block language-vue"},`<!-- ↑ 你也可以使用 html -->
<template>
  <!-- vue 模板 -->
</template>
<script>
...
`),n("span",{class:"token code"},[n("span",{class:"token punctuation"},"```"),n("span",{class:"token code-language"},"json"),s(`
`),n("span",{class:"token code-block language-json"},"// 配置 (可选)"),s(`
`),n("span",{class:"token punctuation"},"```")]),s(`
...
`),n("span",{class:"token code"},[n("span",{class:"token punctuation"},"```"),n("span",{class:"token code-language"},"js"),s(`
`),n("span",{class:"token code-block language-js"},[n("span",{class:"token comment"},"// 放置脚本，并通过 `export default` 导出你的 react 组件")]),s(`
`),n("span",{class:"token punctuation"},"```")]),s(`

`),n("span",{class:"token code"},[n("span",{class:"token punctuation"},"```"),n("span",{class:"token code-language"},"css"),s(`
`),n("span",{class:"token code-block language-css"},[n("span",{class:"token comment"},"/* 你的 css 内容 */")]),s(`
`),n("span",{class:"token punctuation"},"```")]),s(`
...
`),n("span",{class:"token code-block language-md"},[n("span",{class:"token title important"},[n("span",{class:"token punctuation"},"#"),s(" 标题")]),s(`
