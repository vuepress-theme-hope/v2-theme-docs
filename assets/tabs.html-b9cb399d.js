import{$ as u,U as p,a0 as v,aa as b,Y as l,W as s,X as n,a9 as e,ab as d,F as o}from"./framework-3a3055b3.js";const m={},h=n("p",null,"Let the Markdown file in your VuePress site support tabs.",-1),k=n("h2",{id:"config",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#config","aria-hidden":"true"},"#"),e(" Config")],-1),g=n("div",{class:"language-typescript line-numbers-mode","data-ext":"ts"},[n("pre",{ts:"",class:"language-typescript"},[n("code",null,[n("span",{class:"token comment"},"// .vuepress/config.ts"),e(`
...
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9),w={class:"hint-container info"},y=n("p",{class:"hint-container-title"},"Switching together and persisting choice",-1),x=n("p",null,"If you want to make some tab groups switch together, you can use same tab id to bind them.",-1),A=n("p",null,"Also, your choice with that tab id will be stored and persisted.",-1),B=n("p",null,"Here is an example:",-1),T=n("p",null,"Choose a package manager:",-1),C=n("p",null,"npm should be installed with Node.js.",-1),j=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[e("corepack prepare pnpm@latest "),n("span",{class:"token parameter variable"},"--activated"),e(`
`)])])],-1),q=n("p",null,[e("Install "),n("code",null,"vuepress-plugin-md-enhance"),e(":")],-1),N=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),e(" i "),n("span",{class:"token parameter variable"},"-D"),e(` vuepress-plugin-md-enhance
`)])])],-1),U=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"pnpm"),e(),n("span",{class:"token function"},"add"),e(),n("span",{class:"token parameter variable"},"-D"),e(` vuepress-plugin-md-enhance
`)])])],-1),V=n("h2",{id:"demo",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#demo","aria-hidden":"true"},"#"),e(" Demo")],-1),O=n("p",null,"A tab of fruit:",-1),S=n("p",null,"Apple",-1),D=n("p",null,"Banana",-1),E=d(`<div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: tabs#fruit
...
:::
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function W(X,$){const r=o("CodeTabs"),c=o("Tabs");return p(),v("div",null,[h,b(" more "),k,l(r,{id:"7",data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:s(({title:a,value:t,isActive:i})=>[g]),tab1:s(({title:a,value:t,isActive:i})=>[_]),_:1}),f,n("div",w,[y,x,A,B,T,l(c,{id:"49",data:[{title:"npm"},{title:"pnpm"}],"tab-id":"shell"},{tab0:s(({title:a,value:t,isActive:i})=>[C]),tab1:s(({title:a,value:t,isActive:i})=>[j]),_:1}),q,l(c,{id:"62",data:[{title:"Using npm",id:"npm"},{title:"Using pnpm",id:"pnpm"}],"tab-id":"shell"},{tab0:s(({title:a,value:t,isActive:i})=>[N]),tab1:s(({title:a,value:t,isActive:i})=>[U]),_:1})]),V,O,l(c,{id:"77",data:[{title:"apple",id:"apple"},{title:"banana",id:"banana"}],"tab-id":"fruit"},{tab0:s(({title:a,value:t,isActive:i})=>[S]),tab1:s(({title:a,value:t,isActive:i})=>[D]),_:1}),E,l(c,{id:"93",data:[{title:"apple"},{title:"banana"},{title:"orange"}],"tab-id":"fruit"},{tab0:s(({title:a,value:t,isActive:i})=>[I]),tab1:s(({title:a,value:t,isActive:i})=>[Y]),tab2:s(({title:a,value:t,isActive:i})=>[F]),_:1}),H,l(c,{id:"114",data:[{title:"apple"},{title:"banana"},{title:"orange"}]},{tab0:s(({title:a,value:t,isActive:i})=>[J]),tab1:s(({title:a,value:t,isActive:i})=>[L]),tab2:s(({title:a,value:t,isActive:i})=>[M]),_:1}),P])}const G=u(m,[["render",W],["__file","tabs.html.vue"]]);export{G as default};
