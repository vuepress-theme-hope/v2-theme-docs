import{_ as t,r as p,o as i,c as o,b as l,e as n,f as s,a as c,w as u,g as a}from"./app-d7067868.js";const r="/assets/home-light-b511a795.jpg",d="/assets/home-dark-4b9180d3.jpg",k={},v=n("p",null,[n("code",null,"vuepress-theme-hope"),s(" improves the default home page.")],-1),m=n("p",null,[s("To use it, set "),n("code",null,"home: true"),s(" in page frontmatter. Any extra content after the "),n("code",null,"YAML front matter"),s(" will be parsed as normal Markdown and rendered after the features section.")],-1),h=n("p",null,[n("img",{src:r,alt:"Screenshot","data-mode":"lightmode-only",loading:"lazy"}),n("img",{src:d,alt:"Screenshot","data-mode":"darkmode-only",loading:"lazy"})],-1),b=a('<h2 id="site-information" tabindex="-1"><a class="header-anchor" href="#site-information" aria-hidden="true">#</a> Site Information</h2><p>You can use <code>heroText</code> to set the main title and <code>tagline</code> to set the subtitle.</p><p>If you have a logo, you can place it in the <code>public</code> folder and set it via <code>heroImage</code>, if you want to display another logo in night mode, you can use <code>heroImageDark</code>. For better A11y, we recommend that you set the description of Logo to <code>heroAlt</code>.</p><p>You can set the background image through <code>bgImage</code> and <code>bgImageDark</code>, but you need to pay attention that you must fill in the full URL or absolute path. If you want the information to be displayed in full screen, you can set <code>heroFullScreen: true</code>.</p><p>If you need to customize some styles, you can set the style of the logo and background image through <code>heroImageStyle</code> and <code>bgImageStyle</code>.</p><h2 id="home-button" tabindex="-1"><a class="header-anchor" href="#home-button" aria-hidden="true">#</a> Home button</h2><p>You can display some important links in the form of buttons on the home page.</p><p>You can set them via <code>actions</code> which is an array where each element is an object with the following keys:</p><ul><li><code>text</code>: button text</li><li><code>link</code>: button link</li><li><code>type</code>: button type (only <code>&quot;primary&quot;</code> and <code>&quot;default&quot;</code> (default) are supported)</li></ul><h2 id="project-highlights-and-features" tabindex="-1"><a class="header-anchor" href="#project-highlights-and-features" aria-hidden="true">#</a> Project Highlights and features</h2><p>You can set and display project highlights through <code>highlights</code>, which is an array, each element is an object, representing a highlight section.</p><p>You can also set and display project features through <code>features</code>, which is an array, each element is an object, representing a feature section.</p><p>Both highlights and features support <code>header</code> and <code>description</code> properties. Where <code>header</code> is the title of the section and <code>description</code> is the description of the section. You can set HTML string to them.</p><p>Highlights use <code>highlights</code> to set highlights and features use <code>features</code> to set features. Both of them are arrays, each element is an object, representing a highlight or feature item:</p><ul><li><code>title</code>: title, HTML string is supported</li><li><code>details</code>: details, HTML string is supported</li><li><code>icon</code> (optional): can be filled with full path or absolute path image link, or FontClass</li><li><code>link</code> (optional): link address</li></ul><p>Highlights also support the following properties:</p><ul><li><code>color</code>: Text color</li><li><code>image</code>: Section image</li><li><code>imageDark</code>: Section image used in darkmode</li><li><code>bgImage</code>: Section background image</li><li><code>bgImageDark</code>: Section background image used in darkmode</li><li><code>type</code>: <code>&quot;order&quot;</code>, <code>&quot;un-order&quot;</code>(default) or <code>&quot;no-order&quot;</code></li></ul>',17),g={class:"hint-container info"},y=n("p",{class:"hint-container-title"},"Info",-1),f=a(`<h2 id="demo" tabindex="-1"><a class="header-anchor" href="#demo" aria-hidden="true">#</a> Demo</h2><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
...
<span class="token key atrule">highlights</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">header</span><span class="token punctuation">:</span> Add things you want in markdown
    ...
    <span class="token key atrule">highlights</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> Marking contents
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> highlighter
        <span class="token key atrule">details</span><span class="token punctuation">:</span> Custom container<span class="token punctuation">,</span> attrs<span class="token punctuation">,</span> mark and stylize support

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> Writing articles
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> feather
        <span class="token key atrule">details</span><span class="token punctuation">:</span> Custom alignment<span class="token punctuation">,</span> footnote<span class="token punctuation">,</span> snippets include and new image syntax support

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> Richer Your Contents
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> star
        <span class="token key atrule">details</span><span class="token punctuation">:</span> Tex<span class="token punctuation">,</span> presentation<span class="token punctuation">,</span> tabs<span class="token punctuation">,</span> superscript<span class="token punctuation">,</span> subscript<span class="token punctuation">,</span> tasklist and card support

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> Inserting Charts
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> chart<span class="token punctuation">-</span>simple
        <span class="token key atrule">details</span><span class="token punctuation">:</span> Chart.js<span class="token punctuation">,</span> ECharts<span class="token punctuation">,</span> flowchart and Mermaid support

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> Showing your codes and works
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> lightbulb
        <span class="token key atrule">details</span><span class="token punctuation">:</span> Code tabs<span class="token punctuation">,</span> code demo<span class="token punctuation">,</span> playground and vue playground
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function w(I,_){const e=p("RouterLink");return i(),o("div",null,[v,m,h,l(" more "),b,n("div",g,[y,n("p",null,[s("For complete configuration items, see "),c(e,{to:"/config/frontmatter/home.html"},{default:u(()=>[s("Home Frontmatter Configuration")]),_:1}),s(".")])]),f])}const x=t(k,[["render",w],["__file","home.html.vue"]]);export{x as default};
