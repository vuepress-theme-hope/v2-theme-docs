...
<span class="token selector">pre[class*=&quot;language-&quot;]::before </span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function h(k,b){const a=r("RouterLink");return t(),c("div",null,[u,l(" more "),m,n("p",null,[s("See "),i(a,{to:"/ru/config/style.html#color-config"},{default:p(()=>[s("Theme Configuration → Color Settings")]),_:1}),s(" for all available color variables.")]),v])}const f=o(d,[["render",h],["__file","color.html.vue"]]);export{f as default};
