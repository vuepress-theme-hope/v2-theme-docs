...
<span class="token selector">pre[class*=&quot;language-&quot;]::before </span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5);function k(b,h){const e=d("RouterLink");return c(),p("div",null,[u,o(" more "),m,n("p",null,[s("所有可用的颜色变量详见 "),l(e,{to:"/zh/config/style.html#%E9%A2%9C%E8%89%B2%E8%AE%BE%E7%BD%AE"},{default:i(()=>[s("主题配置 → 颜色设置")]),_:1}),s("。")]),v])}const _=t(r,[["render",k],["__file","color.html.vue"]]);export{_ as default};
