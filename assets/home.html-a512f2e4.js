...
<span class="token key atrule">actions</span><span class="token punctuation">:</span>
  <span class="token punctuation">-</span> <span class="token key atrule">text</span><span class="token punctuation">:</span> 快速上手 💡
    <span class="token key atrule">link</span><span class="token punctuation">:</span> /zh/get<span class="token punctuation">-</span>started/
    <span class="token key atrule">type</span><span class="token punctuation">:</span> primary

  <span class="token punctuation">-</span> <span class="token key atrule">text</span><span class="token punctuation">:</span> 指南 🗺️
...
<span class="token key atrule">actions</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">text</span><span class="token punctuation">:</span> 案例 🪀
...
<span class="token key atrule">highlights</span><span class="token punctuation">:</span>
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">header</span><span class="token punctuation">:</span> 在 Markdown 中添加你想要的内容
    ...
    <span class="token key atrule">features</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 组件支持
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> puzzle<span class="token punctuation">-</span>piece
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 在 Markdown 中轻松插入组件
        <span class="token key atrule">link</span><span class="token punctuation">:</span> ./guide/markdown/component.html

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 组件
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> puzzle<span class="token punctuation">-</span>piece
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 开箱即用的常用组件
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">header</span><span class="token punctuation">:</span> 可定制的页面
    <span class="token key atrule">description</span><span class="token punctuation">:</span> 完整无障碍支持的可定制外观
    ...
    <span class="token key atrule">highlights</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 代码块主题
        ...
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 自定义代码块主题
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">header</span><span class="token punctuation">:</span> 布局
    <span class="token key atrule">description</span><span class="token punctuation">:</span> 一个完美的响应式布局。
    ...
    <span class="token key atrule">highlights</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 导航栏
        ...
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 完全可定制的导航栏以及改进的移动端外观
        <span class="token key atrule">link</span><span class="token punctuation">:</span> ./guide/layout/navbar.html

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 侧边栏
        ...
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 从文档标题或文件结构中自动生成侧边栏
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">header</span><span class="token punctuation">:</span> 新功能
    ...
    <span class="token key atrule">features</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 目录页面
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> network<span class="token punctuation">-</span>wired
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 自动生成目录页以及开箱即用的目录组件
        <span class="token key atrule">link</span><span class="token punctuation">:</span> ./guide/feature/catalog.html

      <span class="token punctuation">-</span> <span class="token key atrule">title</span><span class="token punctuation">:</span> 浏览量与评论
        <span class="token key atrule">icon</span><span class="token punctuation">:</span> comment<span class="token punctuation">-</span>dots
        <span class="token key atrule">details</span><span class="token punctuation">:</span> 配合 4 个评论服务开启阅读量统计与评论支持
