import{_ as c}from"./favicon-d825ebf3.js";import{$ as i,U as p,a0 as r,aa as d,Y as u,W as s,X as n,a9 as a,ab as k,F as m}from"./framework-3a3055b3.js";const b={},v=n("p",null,"You can use custom syntax to add attrs for Markdown content.",-1),h=n("h2",{id:"config",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#config","aria-hidden":"true"},"#"),a(" Config")],-1),g=n("div",{class:"language-typescript line-numbers-mode","data-ext":"ts"},[n("pre",{ts:"",class:"language-typescript"},[n("code",null,[n("span",{class:"token comment"},"// .vuepress/config.ts"),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("div",{class:"highlight-lines"},[n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("br"),n("div",{class:"highlight-line"}," "),n("br"),n("br"),n("br"),n("br"),n("br")]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),w=n("div",{class:"language-javascript line-numbers-mode","data-ext":"js"},[n("pre",{js:"",class:"language-javascript"},[n("code",null,[n("span",{class:"token comment"},"// .vuepress/config.js"),a(`
`),n("span",{class:"token keyword"},"import"),a(),n("span",{class:"token punctuation"},"{"),a(" hopeTheme "),n("span",{class:"token punctuation"},"}"),a(),n("span",{class:"token keyword"},"from"),a(),n("span",{class:"token string"},'"vuepress-theme-hope"'),n("span",{class:"token punctuation"},";"),a(`
...
</code></pre></div><h3 id="table-table" tabindex="-1"><a class="header-anchor" href="#table-table" aria-hidden="true">#</a> Table (table)</h3><table class="table"><thead><tr><th>Table</th></tr></thead><tbody><tr><td>content</td></tr></tbody></table><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code>| Table   |
| ------- |
| content |
...
</code></pre></div><h3 id="softbreak-softbreak" tabindex="-1"><a class="header-anchor" href="#softbreak-softbreak" aria-hidden="true">#</a> Softbreak (softbreak)</h3><p class="break">A line with break<br></p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code>A line with break  
{.break}
</code></pre></div>`,37);function y(x,q){const e=m("CodeTabs");return p(),r("div",null,[v,d(" more "),h,u(e,{id:"7",data:[{title:"TS"},{title:"JS"}],"tab-id":"language"},{tab0:s(({title:t,value:o,isActive:l})=>[g]),tab1:s(({title:t,value:o,isActive:l})=>[w]),_:1}),f])}const T=i(b,[["render",y],["__file","attrs.html.vue"]]);export{T as default};
