...
<span class="token code-block language-json language-json"><span class="token comment">// json block is for config</span>
...
`),n("span",{class:"token code-block language-json language-json"},[n("span",{class:"token comment"},"// config (optional)"),s(`
`),n("span",{class:"token punctuation"},"{"),s(`
...
`),n("span",{class:"token code-block language-vue language-vue"},`<!-- ↑ You can also use \`html\` -->
<template>
  <!-- vue template -->
</template>
<script>
...
`),n("span",{class:"token code"},[n("span",{class:"token punctuation"},"```"),n("span",{class:"token code-language"},"js"),s(`
`),n("span",{class:"token code-block language-js language-js"},[n("span",{class:"token comment"},"// your script, exporting your react component through `export default`")]),s(`
`),n("span",{class:"token punctuation"},"```")]),s(`

`),n("span",{class:"token code"},[n("span",{class:"token punctuation"},"```"),n("span",{class:"token code-language"},"css"),s(`
`),n("span",{class:"token code-block language-css language-css"},[n("span",{class:"token comment"},"/* Your css content */")]),s(`
`),n("span",{class:"token punctuation"},"```")]),s(`
